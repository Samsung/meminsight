...
module ___LoggingAnalysis___ {
    ...
    var registrationsTable = allocMap();
    ...
    var scheduledObservers: Array<any> = [];
    ...
    function removeTransientObserversFor(observer) {
        observer.nodes_.forEach(function(node) {
            var registrations = <Array<any>>registrationsTable.get(node);
            if (!registrations)
                return;
    ...
    JsMutationObserver.prototype = {
        observe: function(target, options) {
            ...
            var registrations = <Array<any>>registrationsTable.get(target);
            if (!registrations)
    ...
    export function allocMutationObserver(callback: (arr: MutationRecord[], observer: MutationObserver)=>any): MutationObserver {
