...
// for dumping the staleness output generated by the lifetime analysis
var staleness : fs.WriteStream = null;
var stalenessFileName : string;
...
function initOutputTarget(): void {
    if (args.outputFile) {
        ...
        stalenessFileName = path.join(outputDir, 'staleness.json');
        staleness = fs.createWriteStream(stalenessFileName);
        console.log("Staleness temp: " + stalenessFileName);
...
var runGUIServer = function () {
    ...
    var nodeArgs = ["lib/gui/guiServer.js", path.join(app,"enhanced-trace"), stalenessFileName];
