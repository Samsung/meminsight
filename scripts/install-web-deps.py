...
if platform == "darwin":
    urlretrieve("http://chromedriver.storage.googleapis.com/2.13/chromedriver_mac32.zip",
                "chromedriver.zip")
elif platform == "linux2":
    urlretrieve("http://chromedriver.storage.googleapis.com/2.13/chromedriver_linux64.zip",
                "chromedriver.zip")
else: #windows
    urlretrieve("http://chromedriver.storage.googleapis.com/2.13/chromedriver_win32.zip",
                "chromedriver.zip")
